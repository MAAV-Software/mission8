#ifndef MAAV_SIM_COMMON_HPP
#define MAAV_SIM_COMMON_HPP
/*
...
{
    return ignition::math::Pose3d(pose_gz.pos.x, pose_gz.pos.y, pose_gz.pos.z, pose_gz.rot.w,
        pose_gz.rot.x, pose_gz.rot.y, pose_gz.rot.z);
}
#endif
