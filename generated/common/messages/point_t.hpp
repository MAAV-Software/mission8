...
int point_t::encode(void* buf, uint32_t offset, uint32_t maxlen) const
{
    uint32_t pos = 0;
    int thislen;
...
int point_t::decode(const void* buf, uint32_t offset, uint32_t maxlen)
{
    uint32_t pos = 0;
    int thislen;
...
uint32_t point_t::getEncodedSize() const
{
...
int point_t::_encodeNoHash(void* buf, uint32_t offset, uint32_t maxlen) const
{
    uint32_t pos = 0;
    int thislen;
...
int point_t::_decodeNoHash(const void* buf, uint32_t offset, uint32_t maxlen)
{
    uint32_t pos = 0;
    int thislen;
...
uint32_t point_t::_getEncodedSizeNoHash() const
{
    uint32_t enc_size = 0;
...
uint64_t point_t::_computeHash(const __zcm_hash_ptr*)
{
    uint64_t hash = (uint64_t)0x8d2b34b18854bf32LL;
