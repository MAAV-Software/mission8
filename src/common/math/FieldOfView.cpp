...
FieldOfView::FieldOfView(double hFOV, double vFOV)
: horizontalFOV(hFOV), verticalFOV(vFOV)
{
	double h = 1;
...
FieldOfView::FieldOfView(int width, int height, double dFOV)
: diagonalFOV(dFOV)
{
	double h = height;
	double w = width;
...
double FieldOfView::hFOV() const
{
	return horizontalFOV;
}


double FieldOfView::vFOV() const
{
	return verticalFOV;
}


double FieldOfView::dFOV() const
{
	return diagonalFOV;
}
