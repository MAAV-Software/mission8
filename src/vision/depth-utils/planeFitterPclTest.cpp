...
void randomTest(std::ofstream &fout, std::ofstream &foutError, std::ofstream &foutPCL,
				std::ofstream &foutErrorPCL)
{
	...
	{
		foutErrorPCL << calculateError(coefs, pointsVectors) / pointsVectors.size() << std::endl;
	}
