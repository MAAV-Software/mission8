...
uint64_t __emergency_t_hash_recursive(const __lcm_hash_ptr *p)
{
	...
	uint64_t hash = (uint64_t)0xfa1254ba0baa43aeLL + __int8_t_hash_recursive(&cp) +
...
int __emergency_t_encode_array(void *buf, int offset, int maxlen, const emergency_t *p,
							   int elements)
{
	int pos = 0, element;
	int thislen;
...
int __emergency_t_decode_array(const void *buf, int offset, int maxlen, emergency_t *p,
							   int elements)
{
