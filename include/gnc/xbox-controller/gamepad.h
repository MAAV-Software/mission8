...
#define GAMEPAD_DEADZONE_LEFT_STICK                              \
    7849 /**< Suggested deadzone magnitude for left analog stick \
            */
#define GAMEPAD_DEADZONE_RIGHT_STICK \
    8689 /**< Suggested deadzone magnitude for right analog stick */
//#define GAMEPAD_DEADZONE_LEFT_STICK		2000	/**< Suggested deadzone magnitude for left
// analog
// stick */
//#define	GAMEPAD_DEADZONE_RIGHT_STICK	2000	/**< Suggested deadzone magnitude for right
// analog
// stick */
 ...
 * \param device The device to check.
 * \param button The button to check.
 * \returns GAMEPAD_TRUE if the button has been pressed, GAMEPAD_FALSE if it is not or if it was
 * depressed the previous frame.
 */
 ...
 * \param device The device to check.
 * \param button The button to check.
 * \returns GAMEPAD_TRUE if the button has been released, GAMEPAD_FALSE if it is down or if it was
 * not down the previous frame.
 */
 ...
 *
 * The left motor is the low-frequency/strong motor, and the right motor is the high-frequency/weak
 * motor.
 *
 ...
 */
GAMEPAD_API void GamepadStickNormXY(
    GAMEPAD_DEVICE device, GAMEPAD_STICK stick, float* outX, float* outY);
 ...
 * \returns GAMEPAD_TRUE if the stick is pressed in the specified direction, GAMEPAD_FALSE
 * otherwise.
 */
GAMEPAD_API GAMEPAD_BOOL GamepadStickDirTriggered(
    GAMEPAD_DEVICE device, GAMEPAD_STICK stick, GAMEPAD_STICKDIR dir);
